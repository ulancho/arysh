<div class="container">
	<section class="content-header">
		<ol class="breadcrumb">
			...
			<li><a href="<?= base_url() ?>admin/Goods/all_good_catalogs/<?=$catalog_id?>"><?=$catalog_name?></a></li>
			<li><a href="#">Добавление категории</a></li>
		</ol>
		<br/>
	</section>
	<div class="well well-sm">
		<form action="<?=base_url()?>admin/Goods/add_podcatalog" id="form_add_podcatalog" method="post" enctype="multipart/form-data">
			<div class="row">
				<div class="col-sm-12">
					<div class="pull-right">
						...
						<a class="btn btn-primary" href="<?= base_url() ?>admin/Goods/all_good_catalogs/<?=$catalog_id?>">Назад</a>
					</div>
				</div>
			</div>
	</div>
